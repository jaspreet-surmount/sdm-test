...
@inject('program', 'App\Program')
    ...
    <div class="modal-body">
                ...
                <div class="checkbox">
                    @foreach (\Config::get('constants.FAVORITE_SUBJECTS') as $subject)
                        <label class="control-label marginright10">
                            {!! Form::checkbox('favorite_subjects[]', $subject, in_array($subject, $favoriteSubjects), ['id' => $subject, ]) !!}
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                ] + $program->lists('name', 'id')->toArray(), $student->program_id, ['id' => 'other-activities', 'class' => 'form-control', ]) !!}
            </div>
    ...
    <div class="modal-footer clearfix">
        {!! Form::submit(Lang::get('common.update'), ['class' => 'btn btn-primary']) !!}
    </div>
